...
_DOMAIN_GATE_SYSTEM = (
    ...
    "web for current affairs. Decide whether the user's message is about Indian "
    "GOVERNANCE — the Constitution, law, the judiciary, Parliament, elections, public "
    "administration, constitutional or statutory bodies, government offices and WHO holds "
    "them (current or past), amendments, judgments, and current Indian political/legal/"
    "policy affairs.\n"
    "Answer 'yes' for governance concepts and for the powers, functions, appointment, "
    "tenure, or holders of an office — including officeholder lists and current affairs "
    "(e.g. 'powers of the Prime Minister', 'who appoints the Governor', 'last 10 PMs of "
    "India', 'who is the current CJI', 'what did the 106th Amendment do', 'which PM "
    "imposed the Emergency'). If a genuine governance topic is just awkwardly or "
    "colloquially phrased (e.g. 'money emergency', 'jumps ship'), still answer 'yes'.\n"
    "Answer 'no' when the message is CLEARLY unrelated (cooking, sports, movies, celebrities, "
    "coding, math, personal chit-chat, general science) OR when it is merely BIOGRAPHICAL "
    "or HISTORICAL-EVENT trivia about a political figure with no governance/constitutional "
    "angle — e.g. how a leader died or was assassinated, their personal life, family, "
    "wealth, birthplace, or scandals (e.g. 'how many PMs were assassinated', 'how did "
    "Indira Gandhi die', 'where was Nehru born', 'is the PM married'). Merely mentioning a "
    "politician or an office is NOT enough; the question must be about governance itself, "
    "not a person's life-events or gossip.\n"
    "Reserve 'no' for two cases only: (a) topics clearly unrelated to Indian governance, "
    "and (b) biographical/historical-event trivia about a political figure. For anything "
    "else — including short, vague, or awkwardly phrased messages that could be a "
    "governance concept — answer 'yes'.\n"
